...
public class ReceitaRemedio {
    @Id @Column(name="id_receita") private Integer idReceita;
    @Id @Column(name="id_remedio") private Integer idRemedio;
    ...
    @Column(name="quantidade") private String quantidade;
    @Column(name="dosagem") private String dosagem;
    @Column(name="periodo") private String periodo;
