...
public class Consulta {
    @Id @GeneratedValue(strategy=GenerationType.IDENTITY) @Column(name="id_consulta") private Integer idConsulta;
    ...
    @Column(name="diagnostico", length=200) private String diagnostico;
    @Column(name="data_hora") private LocalDateTime dataHora;
    @Column(name="temperatura", precision=4, scale=1) private BigDecimal temperatura;
    @Column(name="pressao", length=7) private String pressao;
    @Column(name="frequencia_cardiaca") private Integer frequenciaCardiaca;
