...
public class Funcionario {
    @Id @GeneratedValue(strategy = GenerationType.IDENTITY) @Column(name="id_funcionario")
    ...
    @Column(name="telefone", length=15) private String telefone;
    @Column(name="data_nascimento") private LocalDate dataNascimento;
    @Column(name="cpf", length=11, unique=true) @NotBlank(message = "CPF é obrigatório")
    @Size(min=11,max=11,message="CPF deve ter 11 dígitos")
    private String cpf;
    @Column(name="rg", length=9) private String rg;
    @Column(name="endereco", length=120) private String endereco;
    @Column(name="cep", length=8) private String cep;
    @Column(name="uf", length=2) private String uf;
    @Column(name="crm", length=6) private String crm;
    @Column(name="coren", length=20) private String coren;
    public Funcionario() {}
